  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-emerald-100 relative overflow-hidden">
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="fixed top-0 left-0 w-48 sm:w-64 h-full sm:h-full bg-black/70 z-40 flex flex-col pt-15 overflow-y-auto"
          >
            {/* จองคิว */}
            <div
      ...
      <div className="max-w-6xl mx-auto p-6 pt-27 relative z-10">
        ...
        >
          {isGuest ? "ดูคิวจองนวดแผนไทย" : "เลือกพนักงานแพทย์แผนไทยและช่วงเวลา"}
        </h1>
